          ...
          {loading ? (
            ...
            vendors.map((vendor, index) => (
              <div
                ...
                className="cursor-pointer hover:shadow-xl hover:bg-white hover:bg-opacity-40  flex justify-between my-3 items-center w-full p-2 bg-gray-100 bg-opacity-20 rounded-xl"
              >
                <div className="flex-1 flex space-x-3 items-center justify-start">
                  ...
                  />
                  <div>
                    <div className="mb-1 text-lg text-white font-semibold">
                      {vendor.brand}
                    </div>
                    <div className="text-gray-100">{vendor.description}</div>
                  </div>
                </div>
                <div>
